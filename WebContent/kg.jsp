...
.prepareStatement("select count(marks) from quizmarks where username=? and subject=?");
pst.setString(1, name);
pst.setString(2,"Story Learning");
resultSet = pst.executeQuery();
while(resultSet.next()){
	x=resultSet.getInt(1);
}
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-col m6">
  	...
  	<div class="w3-card w3-white w3-hover-shadow w3-padding">
  		<h4><b><i class='fas fa-book-open' ></i>&nbsp;Pictionary</b></h4>
  		<div class="w3-light-grey">
  <div class="w3-red w3-center" style="height:24px;width:<%=z%>"><%=z%></div>
</div>
  <p>Includes Attractive Images</p>

   <p><a href="pictionarymain.jsp" class="w3-button w3-black  w3-hover-black"> View</a></p>
	</div>
  </div>
</div>
 ...
 <!--card-->
 	<div class="w3-card w3-white w3-hover-shadow w3-padding">
 		<h4><b><i class='fas fa-book-open'></i>&nbsp;Story Telling</b></h4>
 		<div class="w3-light-grey">
  <div class="w3-red w3-center" style="height:24px;width:<%=q%>"><%=q%></div>
</div>
  <p>Includes Quizzes</p>

  <p><a href="Storymain.jsp" class="w3-button w3-black w3-hover-black"> View</a></p>
	</div>
  </div>
</div>
