...
<br>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="currpassword" name="current_password" placeholder="Current Password">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="newpassword" name="new_password" placeholder="New Password">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="confirmpassword" name="confirm_password" placeholder="Confirm Password">
    </div>
  </div>
  <br>
  <br>
  ...
  <div class="row">
    <input type="submit" value="Next" style="margin-left: 83%; width:130px; padding: 10px; outline: none" class="w3-button w3-black  w3-hover-blue">
  <br>
  </div>
  </form>
</div>
