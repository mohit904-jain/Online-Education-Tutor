...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h3><b><a id="anchor" href="class12.jsp">Class XII</a> > <a id="anchor" href="class12science.jsp">Science Stream</a></b></h3>
  </header>
 ...
 <!--card-->
 	<div class="w3-card w3-white w3-hover-shadow w3-padding">
 		<h4><b><i class='fas fa-book-open'></i>&nbsp;Physics</b></h4>
  <p>Includes Quizzes</p>
...
<div class="w3-row">
    ...
    <div class="w3-col m6">
        ...
        <!--card-->
        <div class="w3-card w3-white w3-hover-shadow w3-padding">
            <h4><b><i class='fas fa-book-open' ></i>&nbsp;Chemistry</b></h4>
    <p>Includes Quizzes </p>
   ...
   <!--card-->
       <div class="w3-card w3-white w3-hover-shadow w3-padding">
           <h4><b><i class='fas fa-book-open'></i>&nbsp;Biology</b></h4>
    <p>Includes Quizzes</p>
