...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h3><b><a id="anchor" href="kg.jsp">KG</a> > <a id="anchor" href="Storymain.jsp">Story Telling</a></b></h3>
  </header>
  ...
  <div class="w3-col m6">
  	...
  	<!--card-->
  		<div class="w3-card w3-white w3-hover-shadow w3-padding">
  			<h4><b><i class='fas fa-book-open' ></i>&nbsp;Story 1</b></h4>
  			

   			<p><a href="Story1.jsp" class="w3-button w3-black  w3-hover-black"> View</a></p>
		</div>
  	</div>
  </div>
 ...
 <!--card-->
 	<div class="w3-card w3-white w3-hover-shadow w3-padding">
 		<h4><b><i class='fas fa-book-open'></i>&nbsp;Story 2</b></h4>
...
<div class="w3-row">
    ...
    <div class="w3-col m6">
        ...
        <!--card-->
        <div class="w3-card w3-white w3-hover-shadow w3-padding">
            <h4><b><i class='fas fa-book-open' ></i>&nbsp;Story 3</b></h4>
   ...
   <!--card-->
       <div class="w3-card w3-white w3-hover-shadow w3-padding">
           <h4><b><i class='fas fa-book-open'></i>&nbsp;Story 4</b></h4>
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m6">
        ...
        <!--card-->
        <div class="w3-card w3-white w3-hover-shadow w3-padding">
            <h4><b><i class='fas fa-book-open' ></i>&nbsp;Story 5</b></h4>
   ...
   <!--card-->
       <div class="w3-card w3-white w3-hover-shadow w3-padding">
           <h4><b><i class='fas fa-book-open'></i>&nbsp;Story 6</b></h4>
